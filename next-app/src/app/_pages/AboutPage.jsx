    ...
    <main>
        ...
        title={
          <div className="text-white text-center">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
              {isEn ? "About our law firm" : "Σχετικά με το γραφείο μας"}
            </h1>
      ...
      <AboutSection
        ...
        description={
          isEn
            ? [
              "I am a litigation lawyer focused primarily on <strong>Civil Law</strong>, member of the <strong>Piraeus Bar Association</strong>, and an <strong>Accredited Mediator</strong> with further training in <em>family mediation</em>.",
            ]
            : [
              "Είμαι μάχιμη δικηγόρος <strong>αστικού, κυρίως, δικαίου</strong>, μέλος του <strong>Δικηγορικού Συλλόγου Πειραιά</strong> και <strong>διαπιστευμένη Διαμεσολαβήτρια</strong> με μετεκπαίδευση στην <em>οικογενειακή διαμεσολάβηση</em>.",
            ]
        }
        ticks={
          isEn
            ? [
              ...
              "Accredited Mediator",
              "Further training in family mediation",
            ]
            : [
              "Μάχιμη δικηγορία αστικού δικαίου",
              "Μέλος του Δικηγορικού Συλλόγου Πειραιά",
