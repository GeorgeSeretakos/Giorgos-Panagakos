...
export default function BlogPage() {
  ...
  const tabs = [
    { value: "articles", label: isEn ? "Articles" : "Άρθρα" },
    {
      value: "rules",
      label: isEn
        ? "Court Documents & Certificates"
        : "Δικαστικές Αποφάσεις & Πιστοποιητικά",
    },
  ];
  ...
  return (
    <main>
      <div className="w-full bg-[#0E2A4C] shadow-sm">
        <nav className="flex max-w-7xl mx-auto gap-4 p-4 overflow-x-auto scrollbar-hide">
          {tabs.map((tab) => (
            <button
              key={tab.value}
